...
import org.sid.service.ProjectionService;
import org.sid.service.SalleService;
...
public class cinemaRestService {
	...
	public List<Object> findSalles(@PathVariable String name){
		return salleService.getSalleName(name);
	}
	...
	public List<Projection> findProjections(@PathVariable String salle){
		return projectionService.getProjectionName(salle);
	}
